...
<section
class="relative bg-cover bg-center bg-no-repeat " style="background-image: url({{ asset('images/dashboard.jpg') }}" ;>
...
>
  <div class="max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
    <h1 class="text-3xl font-extrabold sm:text-5xl text-neutral-700">
      SPAREPART TERMURAH PELAYANAN MAKSIMAL CEPAT DAN EFISIEN    <strong class="block font-extrabold text-pink-500">
        Bengkel Budi Motor.      </strong>
    </h1>

    <p class="mt-4 max-w-lg sm:text-xl/relaxed">
      Kami mengutamakan integritas di setiap pelayanan kami terhadap konsumen dengan selalu memberikan solusi terbaik
    untuk konsumen seperti kami janjikan.         </p>
...
<a
 ...
 <div>
    <div class="text-center text-4xl font-semibold text-pink-500 m-2 mt-5">Kategori Layanan</div>
    ...
    <div class="container flex gap-10 p-10 pt-3 justify-center mx-auto">
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
          <img class="w-60 rounded-xl" src="{{ asset('images/tune up.png')}}" alt="">
          <span class="text-pink-500 text-2xl">Services Tune up rutin</span>
      </a>
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
        <img class="w-60 rounded-xl" src="{{ asset('images/Kampas Rem.png')}}"  alt="">
        <span class="text-pink-500 text-2xl">penggantian kampas Rem</span>

      </a>
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
        <img class="w-60 rounded-xl" src="{{ asset('images/gantioli.png')}}" alt="">
        <span class="text-pink-500 text-2xl">Ganti Oli</span>

      </a>
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
        <img class="w-60 rounded-xl" src="{{ asset('images/pengganti sparepart.png')}}" alt="">
        <span class="text-pink-500 text-2xl">penggantian sparepart</span>
      </a>
    </div>
...
<div class="flex gap-10 ">
    ...
    <section class="bg-white pt-5">
      <div class="md:w-3/4 mx-auto">
        <div class="mx-auto text-center md:max-w-xl lg:max-w-3xl">
          <h3 class="mb-6 text-3xl text-pink-500 font-bold">Ulasan</h3>
          <p class="mb-6 pb-2 text-gray-700 md:mb-12 md:pb-0">
            ulasan dari pengguna yang percaya kepada kami.
          </p>
        </div>
        ...
        <div class="grid gap-6 text-center p-6 md:grid-cols-3 lg:gap-12">
          <div class="mb-12 md:mb-0">
            <div class="mb-6 flex justify-center">
              <img src="images/testi1.jpg" class="w-32 rounded-full shadow-lg dark:shadow-black/30">
            </div>
            <h5 class="mb-4 text-xl font-semibold">Alanmartha001 Martha</h5>
            ...
            <p class="mb-4 text-neutral-500">
              ...
              Hasil memuaskan harga terjangkau
            </p>
          ...
          <div class="mb-12 md:mb-0">
            <div class="mb-6 flex justify-center">
              <img src="images/testi2.jpg" class="w-32 rounded-full shadow-lg dark:shadow-black/30">
            </div>
            <h5 class="mb-4 text-xl font-semibold">Noerdine Boy</h5>
            <h6 class="mb-4 font-semibold text-primary dark:text-primary-400">
              Pengguna
            </h6>
            <p class="mb-4 text-neutral-500">
              ...
              "Bengkel Motor yang Berpengalaman , Pelayanan yang ramah dan berkualitas "
            </p>
            <ul class="mb-0 flex items-center justify-center">
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5 text-yellow-500">
          ...
          <div class="mb-0">
            <div class="mb-6 flex justify-center">
              <img src="images/testi3.jpg" class="w-32 rounded-full shadow-lg dark:shadow-black/30">
            </div>
            <h5 class="mb-4 text-xl font-semibold">ahong tembong</h5>
            <h6 class="mb-4 font-semibold text-primary dark:text-primary-400">
            pengguna
            </h6>
            <p class="mb-4 text-neutral-500">
    ...
    <div class="">
      ...
      <p class="mb-4">
        <a href="#!" class="text-neutral-600 dark:text-neutral-200"
          >Services Tune Up Rutin</a
        >
      </p>
      <p class="mb-4">
        <a href="#!" class="text-neutral-600 dark:text-neutral-200"
          >Services Penggantian Kampas Rem</a
        >
      </p>
      <p class="mb-4">
        <a href="#!" class="text-neutral-600 dark:text-neutral-200"
      ...
      <p>
        <a href="#!" class="text-neutral-600 dark:text-neutral-200"
          >services Penggantian Sparepart</a
        >
      </p>
    </div>
    <!-- Promotions section -->
