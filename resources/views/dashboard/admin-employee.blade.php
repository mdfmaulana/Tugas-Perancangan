    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 px-4 gap-4">
        ...
        <div class="bg-pink-500  shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-pink-600  text-white font-medium group">
            ...
            <div class="text-right">
                <p class="text-2xl">
                    ...
                    Rp
                    {{ number_format($bookingRevenueThisMonth, 3, '.', ',') }}
                </p>
                <p>Pendapatan pemesanan bulan ini</p>
            </div>
        </div>
        <div class="bg-pink-500  shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-pink-600  text-white font-medium group">
            <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
            ...
            <div class="text-right">
                ...
                <p>Perubahan Pendapatan Bulanan</p>
            </div>
        </div>
        <div class="bg-pink-500  shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-pink-600  text-white font-medium group">
            <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
        ...
        <div class="bg-pink-500  shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-pink-600  text-white font-medium group">
          ...
          <div class="text-right">
            ...
            <p>Penawaran yang akan datang</p>
          </div>
        </div>
        <div class="bg-pink-500  shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-pink-600  text-white font-medium group">
          <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
     ...
     <div class="mt-4">
         @foreach($locations as $location)
             ...
             <div class="grid md:grid-cols-2">
                 <div class="m-3">
                     <h2 class="font-medium text-gray-800 text-xl mb-2">Jadwal Harini</h2>
                     <x-day-schedule :date="\Carbon\Carbon::today()" :location-id="$location->id" />
                 </div>

                 <div class="m-3">
                     <h2 class="font-medium text-gray-800 text-xl mb-2">Jadwal Besok</h2>
