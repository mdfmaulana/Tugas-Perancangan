...
{{--                          </li>--}}
                          ...
                          <li>
                            ...
                            ">
                              ...
                              <span class="ml-2 text-sm tracking-wide truncate">Mengelola Pengguna</span>
                            ...
                            <li>
                                ...
                                <span class="ml-2 text-sm tracking-wide truncate">Mengelola Lokasi</span>
                        ...
                        ">
                          <span class="inline-flex justify-center items-center ml-4">
                            <svg fill="currentColor" class="w-5 h-5" viewBox="0 0 24 24" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"><title/><path d="M18,5V3a1,1,0,0,0-2,0V5H8V3A1,1,0,0,0,6,3V5H2V21H22V5Zm2,14H4V7H20Zm-7-9H11v2h2Zm4,0H15v2h2ZM9,14H7v2H9Zm4,0H11v2h2Z"/></svg>
                                ...
                                <span class="ml-2 text-sm tracking-wide truncate">Mengelola Appointments</span>
                          ...
                          <li>
                            ...
                            ">
                              ...
                              <span class="ml-2 text-sm tracking-wide truncate">Mengelola layanan</span>
                            </a>
                          </li>
                        ...
                        ">
                          <span class="inline-flex justify-center items-center ml-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                                    ...
                                    <span class="ml-2 text-sm tracking-wide truncate">Mengelola kategori</span>
                                </a>
                            </li>
                          ...
                          <li>
                            ...
                            ">
                              ...
                              <span class="ml-2 text-sm tracking-wide truncate">Mengelola Pemesanan</span>
