<div {{ $attributes->class(['m-3']) }}>
    ...
    <table class="w-full border-collapse bg-white text-left text-sm text-gray-500 overflow-x-scroll min-w-screen">
        ...
        <tr>
            <th scope="col" class="pl-6 py-4 font-medium text-gray-900 border p-2">Waktu</th>
            <th scope="col" class="px-4 py-4 font-medium text-gray-900 border p-2">Layanan</th>
            <th scope="col" class="px-4 py-4 font-medium text-gray-900 border p-2">Pengguna</th>
            <th scope="col" class="px-4 py-4 font-medium text-gray-900 border p-2">Email</th>
            <th scope="col" class="px-4 py-4 font-medium text-gray-900 border p-2">No HP</th>
        </tr>
        </thead>
